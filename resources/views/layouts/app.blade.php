        ...
        @auth
            ...
            <div class="sidebar">
                <div class="sidebar-header">
                     <a href="{{ url('/') }}" class="sidebar-brand">
                        <i class="fa-solid fa-wifi me-2"></i>WILINK APP
                     </a>
                </div>
                <ul class="nav flex-column sidebar-nav">
                    ...
                    @if(auth()->user()->role_id == 1) <!-- Admin -->
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ Request::routeIs('admin.stock.create') ? 'active' : '' }}" href="{{ route('admin.stock.create') }}">
                                <i class="fa-solid fa-boxes-stacked"></i> Attribuer Stock
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <nav class="navbar navbar-custom d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center">
                    <span class="me-3 fw-bold text-secondary-custom">{{ Auth::user()->name }}</span>
